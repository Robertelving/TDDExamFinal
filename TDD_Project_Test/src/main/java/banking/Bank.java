...
public class Bank implements BankIF {
    ...
    @Override
    public void transfer(AccountIF sender, AccountIF receiver, BigDecimal amount) throws NegativeTransferAmountException, MoneyLaunderingException, UnrecognizedAccountTypeException {
